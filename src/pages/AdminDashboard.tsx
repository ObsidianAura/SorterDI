...
const mockHouseStats: HouseStats[] = [
  {
    name: "Gryffindor",
  ...
  },
  {
    ...
    count: 12,
    percentage: 24,
    gradient: "from-green-800 to-gray-400"
  },
  {
    name: "Ravenclaw",
...
const mockParticipants = [
  { name: "Harry Potter", email: "harry@hogwarts.edu", house: "Gryffindor", department: "Defense" },
  { name: "Hermione Granger", email: "hermione@hogwarts.edu", house: "Gryffindor", department: "Academics" },
  { name: "Draco Malfoy", email: "draco@hogwarts.edu", house: "Slytherin", department: "Pure Blood Studies" },
  { name: "Luna Lovegood", email: "luna@hogwarts.edu", house: "Ravenclaw", department: "Magical Creatures" },
  { name: "Cedric Diggory", email: "cedric@hogwarts.edu", house: "Hufflepuff", department: "Quidditch" },
];

export const AdminDashboard = () => {
  const navigate = useNavigate();
  const [houseStats, setHouseStats] = useState<HouseStats[]>(mockHouseStats);
